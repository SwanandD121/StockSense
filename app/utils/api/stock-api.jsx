...
export const searchSymbol = async (query) => {
  const url = `${basePath}/search?q=${query}&token=${process.env.NEXT_PUBLIC_FINNHUB_API}`;
...
export const fetchStockDetails = async (stockSymbol) => {
  const url = `${basePath}/stock/profile2?symbol=${stockSymbol}&token=${process.env.NEXT_PUBLIC_FINNHUB_API}`;
  const response = await fetch(url);
...
export const fetchQuote = async (stockSymbol) => {
  const url = `${basePath}/quote?symbol=${stockSymbol}&token=${process.env.NEXT_PUBLIC_FINNHUB_API}`;
  const response = await fetch(url);
...
export const fetchHistoricalData = async (
  ...
  const url = `${basePath}/stock/candle?symbol=${stockSymbol}&resolution=${resolution}&from=${from}&to=${to}&token=${process.env.NEXT_PUBLIC_FINNHUB_API}`;
  const response = await fetch(url);
